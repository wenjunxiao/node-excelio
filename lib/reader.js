...
class SheetReader {
  constructor(sheet, options) {
    ...
    this._dataRowStart = this.rowIdx;
  ...
  reset () {
    this.rowIdx = this._dataRowStart;
    return this;
  }
...
class ExcelReader {
  ...
  readFile (filename, options) {
    this.wb = XLSX.readFile(filename, options);
    return this;
  }

  read (data, options) {
    this.wb = XLSX.read(data, Object.assign({
  ...
  header (titles, opts, mapper) {
    this.curSheet.header(titles, opts, mapper)
    return this;
  }

  tailor (labels) {
    this.curSheet.tailor(labels)
    return this;
  }
